...
const STORAGE_KEY = "genka-app-state-v3.1.3";
const SYNC_QUEUE_KEY = "genka-sync-queue-v3.1.3";
const DEVICE_ID_KEY = "genka-device-id-v3.1.3";
          ...
          <div className="workLayout listLayout">
            <section className="box">
              ...
              {selectedWorks.map((r) => (
                <div className="miniRow" key={r.record_id}>
                  <span>{formatDateTime(r.work_date || r.created_at)}｜{r.hours}h</span>
            ...
            <section className="box">
              ...
              {selectedMaterials.map((r) => (
                <div className="miniRow" key={r.record_id}>
                  <span>{formatDateTime(r.material_date || r.created_at)}｜{r.material_name} {r.material_thickness} {r.material_size}｜{r.qty}枚</span>
